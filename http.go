...
// StartLoggingRequest is used for HTTP request
type StartLoggingRequest struct {
	File string
	Info logger.Info
}

// StopLoggingRequest is used for HTTP request
type StopLoggingRequest struct {
	File string
}

// CapabilitiesResponse is used for HTTP request
type CapabilitiesResponse struct {
	Err string
	Cap logger.Capability
}

// ReadLogsRequest is used for HTTP request
